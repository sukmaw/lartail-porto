...
const MySkills = () => {
  ...
  return (
    <section id="skills" className="pt-10 pb-24">
          ...
          {isAboveMediumScreens ? (
            ...
            >
              <img
                alt="skills"
                className="z-10"
                src={`${url}/assets/skills-image.png`}
              />
            </div>
          ) : (
            <img
      ...
      {/* SKILLS */}
      <div className="md:flex md:justify-content mt-16 gap-32">
        {/* EXPERIENCE */}
        <motion.div
        ...
        >
          ...
          <p className="mt-5">
            ...
            asperiores, esse exercitationem quaerat numquam odit ad mollitia
            earum tempore. Placeat.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">
            ...
            perspiciatis tenetur eaque praesentium qui aut, modi, repellendus
            beatae quos dicta ipsum deleniti necessitatibus magnam.
          </p>
        </motion.div>
