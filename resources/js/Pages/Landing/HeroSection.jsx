      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
        {isAboveMediumScreens ? (
          ...
          >
            <img
              alt="profile"
              className="hover:filter hover:saturate-200 transition duration-500 z-10 w-ful max-w-[400px] md:max-w-[600px]"
              src={`${url}/assets/profile-image.png`}
            />
          </div>
        ) : (
          <img
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            ...
            magni cum, provident animi temporibus soluta,
          </p>
        </motion.div>
